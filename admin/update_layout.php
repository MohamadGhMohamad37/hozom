<?php
include("header.php");
$sql=mysqli_query($conn,"SELECT * FROM `layout` WHERE `id`='$_GET[id]'");
...
?>
      ...
      <div class="container-fluid">
        <div class="container-fluid">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Update Img For Slider</h5>
                <div class="card">
                  <div class="card-body">
                    <form method="post" action="assets/php/class_update.php" enctype="multipart/form-data">
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <textarea class="form-control" name="en" id="exampleFormControlTextarea1" rows="3"><?php echo$row['disc_en'];?></textarea>
                          </div>
                        <div class="mb-3">
                          <label for="exampleFormControlTextarea1">Explanation of Slider in Arabic</label>
                          <textarea class="form-control" name="ar" id="exampleFormControlTextarea1" rows="3"><?php echo$row['disc_ar'];?></textarea>
                        </div>
                        <input type="text" value="<?php echo$row['id'];?>" name="id" hidden>
                      <button type="submit" name="layout_update" class="btn btn-primary">Add</button>
                    </form>
                  </div>
                </div>
              </div>
